...
- **Aristotle** (384-322 BCE): Formal logic, syllogisms, _Organon_
- **Gottlob Frege** (1848-1925): Modern symbolic logic, predicate calculus
- **Bertrand Russell** (1872-1970): _Principia Mathematica_, logical atomism
...
- **Plato** (428-348 BCE): _Theaetetus_, knowledge as justified true belief
- **René Descartes** (1596-1650): _Meditations_, methodical doubt, cogito ergo sum
...
- **Aristotle** (384-322 BCE): _Metaphysics_, substance, causation, potentiality/actuality
...
- **Saul Kripke** (1940-present): _Naming and Necessity_, rigid designators, necessity
...
- **Karl Popper** (1902-1994): Falsificationism, demarcation, _Logic of Scientific Discovery_
- **Thomas Kuhn** (1922-1996): _Structure of Scientific Revolutions_, paradigms, incommensurability
